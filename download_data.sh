...
# =======================================================
NOTEBOOK_URL=http://192.168.99.108/swirrl/jupyter/30afd858-cd07-4087-95bd-8533d6dd1242
SERVICE_ID=30afd858-cd07-4087-95bd-8533d6dd1242
get_notebook http://192.168.99.108/swirrl-api/v1.0/notebook d4583019-2be3-4ce0-9162-09a25270c172 30afd858-cd07-4087-95bd-8533d6dd1242
echo 'Nothing to download from data staging directory.'
download_working_dir_data ${NOTEBOOK_URL}/api/contents
delete_notebook http://192.168.99.108/swirrl-api/v1.0/notebook
